        ...
        success: function (result) {
            if (result.resultCode == 200) {
                ...
                for(var key in result.data) {
                    ...
                    tds += '<td><input id="sta'+key+'"style="width: 100%; border:none;" type="text" value="' + result.data[key].expressStatus + '"></input></td>';
                    tds += '<td><input id="num'+key+'"style="width: 100%; border:none;" type="text" value="' + result.data[key].expressNumber + '"></input></td>';
                    // if (result.data[key].sendType==0){
                    //     tds += '<td><button class="btn btn-info" onclick="orderEdit1('+key+')">发货</button></td>';
                    // }else {
                    //     tds += '<td>修改物流信息</td>';
                    // }
                    tds += '<td><button class="btn btn-info" onclick="orderEdit1('+result.data[key].addressId+','+key+')">确认物流信息</button></td>';
                    str += tds;
                    str += '</tr>';
                }
                str += '</tbody></table>';
